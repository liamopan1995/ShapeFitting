...
public:
	...
	void scale(void);
	void print(void);
	void assignValues(int N, reals dataX[], reals dataY[]);
...
// Method to assign new values to the Data object
void Data::assignValues(int N, reals dataX[], reals dataY[])
{
