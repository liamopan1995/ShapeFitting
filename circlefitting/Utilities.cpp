#ifndef Utilities_H  // Replace "HEADER_NAME_H" with a unique name for this header
#define Utilities_H 
#include "mystuff.h"
#include "circle.h"
#include "data.h"
...
// Data fitting_in_3d(Data& data)
// /*
// this function should take and project a set of 3D points into coords X-Y plane in 2D
// and the question (solve the fitting task in new 2D coords) 
// then it transform the circle center back to 3D coords
// which results in -> Center in 3d, r, normal ,and auxiliary vecotr :u


// stick with Data and Circle at first, later adjust the data structrue according to usage in our programm
// */
// {
//     (void) data;
// }
