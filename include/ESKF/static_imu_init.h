...
class StaticIMUInit {
   public:
    struct Options {
        Options() {}
        //double init_time_seconds_ = 10.0;     // 静止时间 original
        double init_time_seconds_ = 2.0;     // test
        ...
        //bool use_speed_for_static_checking_ = true;  // 是否使用odom来判断车辆静止（部分数据集没有odom选项）original
        bool use_speed_for_static_checking_ = false; //test
    };
