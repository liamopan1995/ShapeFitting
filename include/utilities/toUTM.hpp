// this code script converts longtitude and latitude coordinates into UTM coordinates.
// Folgendes Skript transformiert LAT/LON Daten in UTM Koordinaten:
// GPS topic  name:  /lernsmart/isobus_read/NavSatFix_in
